...
"				<select multiple size=\"5\" style='font-size: small' class=\"form-control\" data-ng-options=\"fake\" name=\"fake\" data-ng-model=\"picklist_src\" data-picklist-src>"+
"				</select>"+
"			</div>"+
"			<div style=\"display: table-cell; width: 5%; vertical-align: middle;\" class=\"btn-group-vertical\">"+
"				<div>"+
...
"			</div>"+
"			<div style=\"display: table-cell; width: 45%;vertical-align: middle;\">"+
"				<select multiple size=\"5\" style='font-size: small' class=\"form-control\" data-ng-options=\"part\" name=\"fake\" data-ng-model=\"picklist_dest\" data-picklist-dest>"+
"				</select>"+
"			</div>"+
"			<div style=\"display: table-cell; width: 5%; vertical-align: middle;\" class=\"btn-group-vertical\">"+
"				<div>"+
